...
- Add a new **table output** which will display the the **first n rows of the dataset selected**. The number of rows should be specified as an input. (Hint: To display the table, in the ui you will use tableOutput, and in the server you will use renderTable)
- Modify the **plot** to only show the **first n rows of the dataset**
